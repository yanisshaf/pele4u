angular.module('pele.controllers', ['ngStorage'])
  ...
  //==                      Setings SendLog                            ==//
  //=====================================================================//
  .controller('SendLogCtrl', function($scope) {}) // SendLogCtrl

  //======================================================================
  //==                          Settings
  //======================================================================
  .controller('SettingsListCtrl', ['$scope', '$fileLogger', '$cordovaFile', '$timeout', '$state', 'PelApi', '$ionicPopup', '$cordovaSocialSharing',
    function($scope, $fileLogger, $cordovaFile, $timeout, $state, PelApi, $ionicPopup, $cordovaSocialSharing) {
      $scope.sendMail = function() {
        ...
        $cordovaFile.readAsDataURL(cordova.file.dataDirectory, config_app.LOG_FILE_NAME)
          .then(function(data) {
            data = data.replace(";base64", ".txt;base64");
            $cordovaSocialSharing
              .shareViaEmail("pele4u log",
                config_app.LOG_FILE_NAME, config_app.LOG_FILE_MAIL_RECIPIENT, null, null, data)
              ...
              $fileLogger.checkFile().then(function(d) {
                resolveLocalFileSystemURL(d.localURL.toString(), function(entry) {
                  ...
                  window.cordova.plugins.email.open({
                    to: config_app.LOG_FILE_MAIL_RECIPIENT, //'Mobile_Admins_HR@pelephone.co.il',
