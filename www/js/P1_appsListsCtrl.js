      ...
      retGetFileURI.then(
        ...
        function() {
          retGetFileURI.success(function(data, status, headers, config) {
            PelApi.lagger.info("===== P1_appsListCtrl.setSettings( SUCCESS ) ======");
            ...
            if ("S" === statusCode.Status) {
              ...
              $cordovaFileTransfer.download(url, targetPath, {}, true)
                .then(function(result) {
                  ...
                  PelApi.lagger.info('$cordovaFileTransfer.download(Success)');
                  ...
                  PelApi.lagger.error('$cordovaFileTransfer.download( ERROR ) - ' + error);
                  $ionicLoading.hide();
                  $scope.$broadcast('scroll.refreshComplete');
        ...
        function(response) {
          ...
          PelApi.lagger.error("===== P1_appsListCtrl.setSettings( ERROR ) ======");
